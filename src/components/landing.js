          ...
          <div className="row">
            <div className="col s10 l4 m6 offset-l4 offset-m3 offset-s1">
              <div className="card-panel welcome">
                ...
                <p>Join a community of other graffiti lovers. From Banksy to Stik, easily find the best street art in your neighbourhood and the rest of London. Plus, don&#39;t forget to share your own spots!</p>
